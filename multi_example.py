...
class Control(object):
    def __init__(self):
        ...
        useremail_input = TextBox((85, 278, 305, 45), command=self.change_color, clear_on_enter=True, inactive_on_enter=False)
        username_input = TextBox((85, 364, 305, 45), command=self.change_color, clear_on_enter=True, inactive_on_enter=False, active=False)
        password_input = TextBox((85, 453, 305, 45), command=self.change_color, clear_on_enter=True, inactive_on_enter=False, active=False)
