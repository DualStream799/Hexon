...
cursor_y_pos = np.array([0.0, 69.0, 109.0, 104.0, 55.0, -19.0, -84.0, -113.0, -94.0, -37.0, 36.0, 93.0, 113.0, 85.0, 20.0, -54.0, -104.0, 
						 ...
						 110.0, 104.0, 53.0, -21.0, -85.0, -113.0, -93.0, -35.0, 37.0, 95.0, 113.0, 83.0, 18.0, -56.0, -105.0, -109.0,
						 ]) 

def orbital_cycle(planet_solution):
    cycle_count = 0
    val_list = planet_solution
...
print(len(cursor_y_pos))
print(orbital_cycle(cursor_y_pos))
